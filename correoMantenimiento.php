...
$jefe = 'rafael@mess.com.mx'; // Mantener esto para pruebas
...
try {
    ...
    <body>
        ...
        <center>
            <h1>
                ' . htmlspecialchars($solicitaN) . ' acaba hacer una solicitud de mantenimiento a través del sistema de Control Vehicular
            </h1>
            <br><br>
            <h2>
                Para validar la solicitud de mantenimiento por favor entra al sistema de control vehicular.<br> 
